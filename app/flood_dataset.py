...
from app.stations import load_usgs_stations
from arg_parser import parse_arguments, print_filter_settings

class FloodDatasetBuilder:
    api_config = api_config.load_api_config()

    def __init__(self, target_state=None, months=None, years=None):
# ================= CONFIG =================
# Load API configuration
api_config = api_config.load_api_config()

# DATA STORAGE PATHS
#RAW_DATA_DIR = api_config.get['API_KEYS', 'raw_data_dir']
